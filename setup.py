...
import setup_soundtouch
import setup_rtaudio
import setup_rtmidi
import setup_sndfile
import setup_pk
import setup_scosc

ext_modules = []
ext_modules += setup_rtaudio.ext_modules
ext_modules += setup_rtmidi.ext_modules
ext_modules += setup_soundtouch.ext_modules
ext_modules += setup_sndfile.ext_modules
